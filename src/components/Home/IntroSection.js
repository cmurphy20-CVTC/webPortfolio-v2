    ...
    <section class="row intro justify-content-center">
      <div className="row">
        <div class="col introDiv">
          ...
          <div class="row justify-content-center">
            <h3>
              I design and create applications that make the client's life
              easier using JavaScript, React, Node.js, and Express
            </h3>
          </div>
      ...
      <div class="row introContent justify-content-center">
        <div class="col-lg-12 col-md-12 col-sm-12">
          ...
          <p id="introContentP">
            I am a web developer with a passion for learning how to solve
            problems because I'm helpful to a fault. I'm naturally curious and
            perpetually working on improving my skills one problem at a time.
          </p>
        </div>
      </div>
    </section>
